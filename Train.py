...
import pytorch_ssim
from DataUtils import TrainDataSet, ValDataSet, display_transform
...
def main():
    ...
    train_set = TrainDataSet('data/VOC2012/train', crop_size=CROP_SIZE, upscale_factor=UPSCALE_FACTOR)
    val_set = ValDataSet('data/VOC2012/val', upscale_factor=UPSCALE_FACTOR)
